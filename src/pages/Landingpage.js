        ...
        <div className={styles.upper_box}>
          ...
          <div className={styles.left_box}>
            <div className={styles.sigin}>
              <Link to="/signup">
                <p className={styles.text_box}>Sigin</p>
              </Link>
            </div>
        ...
        <div className={styles.lower_box}>
          <div className={styles.lower_left}>
            ...
            <p className={styles.cont_p}>
              ...
              voluptates tenetur, quod sapiente accusantium aliquam
              reprehenderit nostrum alias provident a itaque ullam. Iusto
              consequatur cupiditate, esse perspiciatis praesentium adipisci?
              Quaerat.
            </p>
            <div className={styles.left_box}>
              <div className={styles.sigin}>
